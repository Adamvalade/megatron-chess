...
libengine.so: interface.o board.o engine.o Piece.o game.o
	$(CXX) $(CXXFLAGS) -shared -fPIC -o libengine.so interface.o board.o engine.o Piece.o game.o
.PHONY: libengine.so
...
letterman.o: letterman.cpp letterman.h
